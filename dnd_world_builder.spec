...
# qt-material removed — themes are generated by core/theme_engine.py
...
a = Analysis(
    ...
    datas=[
        ...
        # User documentation
        ('docs/user', 'docs'),
        # Voice recordings (user-created reference audio)
        ('assets/voice_recordings', 'assets/voice_recordings'),
    ],
    hiddenimports=[
        'aiohttp',
        'PyQt5.sip',
